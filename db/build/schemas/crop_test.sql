DROP DATABASE IF EXISTS crop_test;
CREATE DATABASE crop_test CHARACTER SET utf8 COLLATE utf8_general_ci;
USE crop_test;

/*
 * Create user with grants
 */
grant all on crop_test.* to 'crop'@'localhost' identified by 'crop';
