<div class="about">
    ...
    <div class="figure fig3 left">
        ...
        <div class="info">
            ...
            <p>
                Хотите помочь сделать проект лучше? Очень будем рады!
                Присылайте свои вопросы/пожелания/предложения, будем очень рады.
                При этом просьба указывать соответствующую тему письма, например:
                <b>Предложения по дизайну</b> или <b>Идея для проекта</b>.
            </p>
        </div>
    </div>
